...
- What happens immediately following a far-right speech?
- **Expected**: anger ↑, positive emotional language ↓; even if the aggregate is positive
:::
::: {.column width="2%"}
:::
::: {.column width="49%" .fragment}
...
| Parliament | Period | AfD entered parliament in |
|:---|:---:|:---:|
| Hesse | 2013–2025 | 2018 |
| Saxony-Anhalt | 2021–2025 | 2016 |
| Saxony | 2019–2025 | 2014 |
...
**H2**: Speeches <em>after</em> AfD interventions contain more anger and less positive language
...
## Modality- and Emotion-Specific Transmission {data-auto-animate=true}

```{=html}
<div style="position:relative; text-align:center;">
  <img src="figures/fig_h5_coef_sent_slide.png"
       style="width:82%; max-height:610px; object-fit:contain; display:inline-block;">
...
## Modality- and Emotion-Specific Transmission {data-auto-animate=true data-visibility="uncounted"}

::: {.columns}
::: {.column width="50%"}
**H3: Modality-specific transmission**

- Vocal far-right intensity → pitch elevation in mainstream audio
- Negative emotions in far-right text → more negative emotions in mainstream text
:::
::: {.column width="50%" .fragment}
**H4a/b: Emotion-specific coupling**

- Far-right anger → pitch elevation in mainstream audio (H4a)
...
## Average vs. Sequential Mirroring (descriptive) {data-visibility="uncounted"}
