...
format:
  revealjs:
    ...
    center: false
    incremental: false
    footer: "Arnold, Kuepfer, Stecker | EPSS Annual Meeting · Belfast, UK · June 2026"
    controls: true
...
## Result 2: Average vs. Sequential {data-auto-animate=true}


**H2:** Sequential mirroring: speeches <em>after</em> AfD interventions contain more anger and less positive language (descriptive)
...
## Result 2: Average vs. Sequential {data-auto-animate=true data-visibility="uncounted"}


**H2**: Sequential mirroring: speeches <em>after</em> AfD interventions contain more anger and less positive language (modelled)

::: {style="text-align:center;"}
![](figures/fig_fd_h1_h2_sent_slide.png){width="96%" style="max-height:560px; object-fit:contain;"}
:::
...
## Result 3: Modality-Specific Transmission
...
<div style="position:relative; text-align:center;">
  <img src="figures/fig_h5_coef_sent_slide.png"
       style="width:82%; max-height:550px; object-fit:contain; display:inline-block;">
  <!-- Fragment 1: Audio/Pitch row (horizontal band) -->
  ...
  <!-- Fragment 2: Negative emotions, Text reaction (left portion) -->
...
## Result 4: Emotion-Specific Coupling
...
```{=html}
<div style="position:relative; text-align:center;">
  <img src="figures/fig_h5_discrete_sent_slide.png"
       style="width:80%; max-height:550px; object-fit:contain; display:inline-block;">
  <div class="fragment fade-in-then-out" data-fragment-index="1"
       style="position:absolute; top:57%; left:10%; width:81%; height:16%;
              border:3px solid #2a7ab5; border-radius:4px;
              background:rgba(42,122,181,0.08); pointer-events:none;"></div>
  <div class="fragment fade-in-then-out" data-fragment-index="2"
       style="position:absolute; top:8%; left:10%; width:45%; height:25%;
              border:3px solid #2a7ab5; border-radius:4px;
              background:rgba(42,122,181,0.08); pointer-events:none;"></div>
  <div class="fragment" data-fragment-index="3"
       style="position:absolute; top:34%; left:54%; width:35%; height:23%;
              border:3px solid #2a7ab5; border-radius:4px;
              background:rgba(42,122,181,0.08); pointer-events:none;"></div>
</div>
```
...
Christian Arnold · Andreas Kuepfer · Christian Stecker<br><br>
